<section id="our-team" class="section-right-img our-team">
    <div class="container-wrapper">
        <div class="container">
            <div class="group-vert" data-aos="fade-up" data-aos-easing="ease-out" data-aos-duration="900">
                <h2>Our team</h2>
                <p>The Agapé crew is a fun loving and down to earth bunch who are committed to premium levels of skill and service. We take time out to train in the latest techniques to make sure you are looking your best.</p>
                <a href="<?php echo get_site_url(); ?>/team" class="button">
                    Meet the crew
                </a>
            </div>
        </div>
    </div>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="259.898" height="277" viewBox="0 0 259.898 277" data-aos="slide-left" data-aos-easing="ease-out-cubic" data-aos-duration="600" data-aos-delay="600" >
